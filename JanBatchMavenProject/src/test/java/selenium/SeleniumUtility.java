...
public class SeleniumUtility {
	...
	/**
	 * this method clears the data in the text box
	 * @param locatorType id,name,class,xpath,css
	 * @param locator
	 * @param textValue
	 * @throws Exception 
	 */
	public void textBoxClear(String locatorType, String locator) throws Exception{
		try {
			//locateElement(locatorType, locator).sendKeys(textValue);
			element = locateElement(locatorType, locator);
			element.clear();
...
/**		File file = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	...
	public String alerthandling(boolean accept){
