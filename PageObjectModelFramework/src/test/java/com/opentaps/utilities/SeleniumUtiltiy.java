package com.opentaps.utilities;
	...
	public void launchBrowserAndApp(String browserName, String appURL){
		...
		try {
			if(browserName.equals("firefox")){
				System.setProperty("webdriver.gecko.driver", "C:\\softwares\\selenium jars\\chromedrive\\chromedriver.exe");
				driver = new FirefoxDriver();
			}else if(browserName.equals("chrome")){
				System.setProperty("webdriver.chrome.driver", "C:\\softwares\\selenium jars\\chromedrive\\2.34\\chromedriver.exe");
