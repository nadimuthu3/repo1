...
public class LeadModule extends SeleniumUtiltiy{
	...
	public  void createLead() throws InterruptedException{
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Moolya");// Company Name
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Soubhagya");// First Name
		
		WebElement ele2=driver.findElement(By.id("createLeadForm_dataSourceId"));// Source
		Select st2=new Select(ele2);
		st2.selectByVisibleText("Cold Call");
		...
		driver.findElement(By.id("createLeadForm_birthDate")).sendKeys("15/04/1994");// Birthday
